...
contract PlonkVerifier {
    ...
    uint16 constant nPublic   = 21;
    uint16 constant nLagrange = 21;
    
    uint256 constant Qmx  = 16476298081373872031773180355824047435730345177927775325168344846812724784987;
    uint256 constant Qmy  = 13789621549587949186237949401124617046511519926043158477887850571821935668956;
    uint256 constant Qlx  = 9400431541042743906523131946631690932600147333169015437656109347551483841614;
    uint256 constant Qly  = 11039630685785349736720367783254904940885904995886618601471502348336976945760;
    uint256 constant Qrx  = 9281851846320304546361654918550969213281873555157405607279864377689853526698;
    uint256 constant Qry  = 213320929300825537624512961082443423129071269870426805601850226032345307259;
    uint256 constant Qox  = 15349295498742639217464485705551101208450541849173113094551187484158161667081;
    uint256 constant Qoy  = 18624135629802872768752911577667434165615386893707273135392876589901447617674;
    uint256 constant Qcx  = 1224679681471890772956453621386587155442779986553634419328982930014875724015;
    uint256 constant Qcy  = 10924378845051705329764506976715173616716428796610709140345539231000797187553;
    uint256 constant S1x  = 21797570906700939489402857628114250034938846247247194075787644974443695234113;
    uint256 constant S1y  = 4091237150919441430206144641717402414084847291677348478760675941081261840458;
    uint256 constant S2x  = 19518413308645917186355180533770509092295004391590554356088301011506613844775;
    uint256 constant S2y  = 17533420043818051367031502526997193825860828207974785800252038518453919063066;
    uint256 constant S3x  = 16028797105206432835861256557867651761397915296661747831227818129687624607221;
    uint256 constant S3y  = 19220150900664144754745697510908738532739813639317254164053052298931662425760;
    ...
    function verifyProof(uint256[24] calldata _proof, uint256[21] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1184 ), calldataload(pA))
                mstore(add(mIn, 1216 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1248 ), calldataload(pB))
                mstore(add(mIn, 1280 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1312 ), calldataload(pC))
                mstore(add(mIn, 1344 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1376), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 22 )
