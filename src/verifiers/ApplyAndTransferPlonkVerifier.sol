...
contract PlonkVerifier {
    ...
    uint16 constant nPublic = 19;
    uint16 constant nLagrange = 19;

    uint256 constant Qmx = 16073083779371975814913801074303403860145899609693418942138864487452555556440;
    uint256 constant Qmy = 6914267498562180741835559009874649029445625666857621248910394904753533693824;
    uint256 constant Qlx = 2245070278456271340631077793148428894293956379663931835605065456400146410724;
    uint256 constant Qly = 5071816138540770971268079982956457315473226391189813872869529010477143125048;
    uint256 constant Qrx = 18280751043159071494330154524374137488979801839478654119611890682182036915449;
    uint256 constant Qry = 17794070016779763320232257751857137080749508514786981996436244383468263484634;
    uint256 constant Qox = 18854527304251057627795451287444688070669806226023738013247765860016989711392;
    uint256 constant Qoy = 7502660144068345260455442918095531217352715856728167175991422985671625502958;
    uint256 constant Qcx = 17177703814758549632843088041755851867832339515659963844597616834237693072834;
    uint256 constant Qcy = 10193181321196174020402231005967934992397169559638425209202299807457689181056;
    uint256 constant S1x = 16970374396958966835872269592711574421948688393563314063070469395549404958375;
    uint256 constant S1y = 17150909541166463359370810623720793644572143791475419901143621721770006024857;
    uint256 constant S2x = 8203983648721737656653893263273848490847528596469756089362572484384105065310;
    uint256 constant S2y = 9325161630410211122091973663402844164153501671408032067835906848614745731545;
    uint256 constant S3x = 7186450825528147568497028620142343751714587389311884764850398642665508964875;
    uint256 constant S3y = 15395930151891785754377183676246821261557528849694286777564481377119198748089;
    ...
    function verifyProof(uint256[24] calldata _proof, uint256[19] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1120), calldataload(pA))
                mstore(add(mIn, 1152), calldataload(add(pA, 32)))
                mstore(add(mIn, 1184), calldataload(pB))
                mstore(add(mIn, 1216), calldataload(add(pB, 32)))
                mstore(add(mIn, 1248), calldataload(pC))
                mstore(add(mIn, 1280), calldataload(add(pC, 32)))

                beta := mod(keccak256(mIn, 1312), q)
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 20)
