...
contract PlonkVerifier {
    ...
    uint256 constant Qmx = 111234706503794392695895805175203160865703908247164298288685089317122175361;
    uint256 constant Qmy = 14451845022799288869348780736571864678725346845283195391731693352985940860315;
    uint256 constant Qlx = 15186556513628574852798724215378679602479229575585201391916524466712599890055;
    uint256 constant Qly = 4617426627390993985016418349333813839184844438610769504380462260507557053907;
    uint256 constant Qrx = 21266531027410333728796149255222100421589996217615880131308194103128358574396;
    uint256 constant Qry = 13807342438482172919847163643080079935438484512316080926870057804139514177426;
    uint256 constant Qox = 8546319657996453133128200736103049604546322760669050384370346040571522506586;
    uint256 constant Qoy = 18977082243508345729819437474012826205374116053301483857621795947984279040966;
    uint256 constant Qcx = 12260696241145578734814779982496653806233876862431889586071982766053755679792;
    uint256 constant Qcy = 2155843920171939642837603347506077516993418401849986537787359627000409228223;
    uint256 constant S1x = 5673417928035112337851443929777428359499161262121994656101737157416826173188;
    uint256 constant S1y = 13388817425992894028030998329930874708717201824259275580950692565059954398485;
    uint256 constant S2x = 8165208356060419433245033807901852954066382127477644193592776467790026825107;
    uint256 constant S2y = 21318683094447153334956778408145109271444074008202857841947697599259262726533;
    uint256 constant S3x = 3615871298265058702591689158877793678910724862652615857502488671714934210656;
    uint256 constant S3y = 17439407127506149031543219779989958314925656791779163615018396232141471586848;
    ...
    function verifyProof(uint256[24] calldata, uint256[7] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
